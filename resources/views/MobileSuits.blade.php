<x-base>
    <x-slot name="head">
        <x-head>
            <x-slot name="title">
                <title>HomeHive - List of Mobile Suits</title>
            </x-slot>
        </x-head>
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 id="header-h1" class="h3 mb-0 text-800">List of Mobile Suits</h1>
            </div>
                ...
                <div class="col-lg mb-4">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Mobile Suit Log</h6>
                        </div>
                        <div class="card-body">
                            <p>
                                <ul>
                                    ...
                                    <li>
                                        <a href="/MobileSuits/{{ $MobileSuit['id'] }}">    
                                            <b>{{ $MobileSuit['model'] }}</b>
                                        </a>
                                    </li>
                                    @endforeach
                                </ul>
