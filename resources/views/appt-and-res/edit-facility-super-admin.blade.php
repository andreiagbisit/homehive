                                            ...
                                            <div id="months-checkboxes">
                                                @foreach(['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] as $month)
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="{{ strtolower($month) }}">{{ $month }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            @foreach($facility->timeSlots as $timeSlot)
                                                <div class="row time-slot">
                                                    <div class="col">
                                                        ...
                                                        <input type="time" name="start_times[]" class="form-control" required value="{{ \Carbon\Carbon::parse($timeSlot->start_time)->format('H:i') }}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="end_times[]">End Time</label>
                                                        <input type="time" name="end_times[]" class="form-control" required value="{{ \Carbon\Carbon::parse($timeSlot->end_time)->format('H:i') }}">
                                                    </div>
