<x-base>
    <x-slot name="head">
        <x-head>
            <x-slot name="title">
                <title>Manage Subdivision Facilities - View Facility</title>
            </x-slot>
        </x-head>
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 id="header-h1">Manage Subdivision Facilities - View Facility</h1>
            </div>
            <!-- Content Row -->
            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-3 float-right">
                                <a style="border-radius: 35rem; padding: .75rem .1rem; line-height: 1.5;" id="appt-and-res-button-submit" href="{{ route('manage.facilities.admin') }}" class="btn btn-secondary btn-user btn-block font-weight-bold text-white">
                                    BACK
                                </a>
                            </div>
                        </div>
