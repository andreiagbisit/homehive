                ...
                <div class="col-lg-7 mb-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('bulletin.board.update.superadmin', $entry->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        href="{{ auth()->user()->account_type_id == 1 ? route('bulletin.board.superadmin') : route('bulletin.board.superadmin') }}"
