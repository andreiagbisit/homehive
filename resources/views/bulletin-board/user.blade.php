            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="color: #000; padding: 20px;">
                    ...
                    <div class="modal-footer" style="justify-content: center;">
                        <a id="bulletinEntryModalEdit" href="#" style="display: none; font-weight: bold; color: #000; border-radius: 35rem; padding: .75rem .1rem; line-height: 1.5;" class="btn btn-warning btn-user btn-block font-weight-bold col-sm-3">EDIT ENTRY</a>

                        <a href="#" id="bulletinEntryModalDelete" data-entry-id="" style="display: none; font-weight: bold; border-radius: 35rem; padding: .75rem .1rem; line-height: 1.5;" class="btn btn-danger btn-user btn-block font-weight-bold text-white col-sm-3" data-toggle="modal" data-target="#deleteEntryModal">DELETE ENTRY</a>
