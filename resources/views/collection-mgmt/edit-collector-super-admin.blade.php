                                ...
                                <form class="user">
                                    <div class="form-group row mt-4 mb-4">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" id="form-text" class="form-control form-control-user" required value="John Doe">
                                        </div>

                                        <div class="col-sm-6">
                                            <p id="input-label">GCash No. <span style="color: red;">*</span></p>
                                            <input type="text" id="form-text" class="form-control form-control-user" required value="09102345678">
                                        </div>
                                    </div><hr>
                                    ...
                                    <div class="pl-3 pr-3 mt-4">
                                        ...
                                        <script>
                                            function applyInitialValues() {
                                                ...
                                                document.getElementById('collector-approach-rate-frequency').style.color = defaultColor;
                                                document.getElementById('collector-approach-rate-percentage').style.color = defaultColor;
                                                document.getElementById('collector-approach-rate-progress-bar').style.backgroundColor = defaultColor;
                                            }
