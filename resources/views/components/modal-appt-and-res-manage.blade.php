        ...
        <div class="modal-content" style="color: #000; padding: 20px;">
            ...
            <div class="modal-body">
                <div id="modalContentArea">
                    ...
                    <h5 id="page-desc">'User' Account Type</h5><hr><br>
                    ...
                    <div class="form-group text-center pl-2">
                        <img id="appt-and-res-img" class="img-fluid mt-3 mb-4" src="{{ url('img/bball-court.jpg') }}"><br><br>
                                
                                <span id="media-upload-info">
                                    <i class="fas fa-image pr-2"></i> bball-court.jpg | 64 KB
                                </span><br><br>
                    ...
                    <div class="form-group text-center pl-2">
                        <img id="appt-and-res-img" class="img-fluid mt-3 mb-4" src="{{ url('img/pool.jpg') }}"><br><br>
                                
                                <span id="media-upload-info">
                                    <i class="fas fa-image pr-2"></i> pool.jpg | 91 KB
                                </span><br><br>
