...
<div class="modal fade" id="deleteEntryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="color: #000;">
            ...
            <div class="modal-body">Are you sure you want to permanently delete this entry? This action cannot be undone.</div>

            <div class="modal-footer d-inline">
                <div class="form-group mb-3">
                    <a style="border-radius: 35rem; padding: .75rem .1rem; line-height: 1.5;" class="btn btn-danger btn-user btn-block font-weight-bold" href="#" style="color: #000; font-weight: bold;">Delete Entry</a>
                </div>
